...
![图 19.1: 翻译步骤](http://aosabook.org/images/pypy/translation_steps.png)
...
![图19.2: 阶乘的流图](http://aosabook.org/images/pypy/flowgraph.png)
...
![图19.3: 在防护失败时回退到解释器](http://aosabook.org/images/pypy/guard_fails.png)
...
![图19.4: 展示 Python 字节码和对应 JIT IR 操作的 jitviewer](http://aosabook.org/images/pypy/jitviewer.png)
